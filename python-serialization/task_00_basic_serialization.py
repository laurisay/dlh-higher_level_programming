#!/usr/bin/python3
"""
Basic serialization module that provides functions to serialize a Python
dictionary to a JSON file and deserialize a JSON file back to a Python dictionary
"""
import json
